...
<!-- <div class="home-video-question">
    <div class="div">
        ...
        <p class="pertanyaan-akan">Pertanyaan akan dibacakan<br />didalam video diatas</p>
        <div class="group-6">
            <div class="rectangle"></div>
            <div class="text-wrapper-6">Bantuan</div>
            <img class="group-7" src="https://c.animaapp.com/jpVby7k9/img/group-8@2x.png" />
        </div>
        <div class="group-8">
            <div class="overlap-5">
                <div class="rectangle-2"></div>
                <div class="text-wrapper-7">Koala</div>
                <div class="group-9">
                    <div class="overlap-group-4">
                        <div class="text-wrapper-8">B</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="group-10">
            <div class="overlap-6">
                <div class="text-wrapper-9">Kangguru</div>
                <div class="group-9">
                    <div class="overlap-group-4">
        ...
        <div class="group-11">
            <div class="overlap-5">
                <div class="rectangle-2"></div>
                <div class="text-wrapper-11">Tikus Berkantung</div>
                <div class="group-9">
                    <div class="overlap-group-4">
                        <div class="text-wrapper-10">D</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="group-12">
            <div class="overlap-5">
                <div class="rectangle-2"></div>
                <div class="text-wrapper-12">Bekantan</div>
                <div class="group-9">
                    <div class="overlap-group-4">
                        <div class="text-wrapper-10">C</div>
                    </div>
                </div>
            </div>
        </div>
