                            ...
                            <div class="card card-addon">
                                <div class="card-body text-center">
                                    <div class="card-image text-center mb-3">
                                        <img src="{{ asset('assets/img/girl-happy.png') }}" class="img-card-item">
                                    </div>
                                    <h4 class="mb-3">Selamat<br>Proses Redeem<br>Berhasil</h4>
                                    <p class="text-secondary">Kamu akan dihubungi oleh team CS kami<br>atau km bisa hubungi no CS :<br>081283609638</p>
                                </div>
                            </div>
                        </div>
                    </div>
